...
create table pcategory(
    ...
    insert pcategory(pcname) values('스마트폰');
...
create table product(
    ...
    pcontent	longtext,
    pprice 		int unsigned default 0 not null,			-- signed(기본값:음수사용o) / unsigned(음수사용x -> 음수만큼의 메모리를 양수로 사용) : 음수 사용여부 체크
    pstate 		tinyint not null,		-- [ 0 : 판매중(기본값), 1 : 거래중, 2 : 판매대기, 3: 판매완료 ]
